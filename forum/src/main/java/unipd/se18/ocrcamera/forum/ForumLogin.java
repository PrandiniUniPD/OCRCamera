...
public class ForumLogin extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Definition of Login_VM view model listener
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //If only one of the fields is null, an error is shown
                if (usernameEditText.getText() != null && pwdEditText.getText() != null) {

                    //The text objects are not null, so their value is prepared to be checked
                    userName = usernameEditText.getText().toString();
                    userPwd = pwdEditText.getText().toString();

                    if (!userName.equals("") && !userPwd.equals("")) {

                        //If not empty, the credentials are handed to Login_VM to be checked
                        viewModel.loginToForum(requireContext(), userName, userPwd);
                    }
                    else {

                        //If empty, a warning toast is shown to the user
                        Toast.makeText(getContext(), R.string.loginButtonErrorToast, Toast.LENGTH_LONG)
                                .show();
                    }
                }
                else {

                    //If null, a warning toast is shown to the user
                    Toast.makeText(getContext(), R.string.loginButtonErrorToast, Toast.LENGTH_LONG)
                            .show();
                }
            }
