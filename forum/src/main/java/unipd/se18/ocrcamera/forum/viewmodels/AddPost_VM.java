 ...
 * (architecture used: Model (the Post) - View (the adding post view) - ViewModel (the worker class))
...
public class AddPost_VM implements AddPostsMethods {
    ...
    /*
    The next listener is provided by this class and it will be implemented by the View class
    for receiving notifications about the work of this ViewModel class.
     */
    ...
    /*
    The next listener is provided by the class used for communicating with the server that hosts
    the forum (RequestManager).
     */ 
    ...
    private RequestManager.RequestManagerListener requestManagerListener =
	    ...
	    // Notifies the event to the View
    ...
    (String title, String message, String author) throws JSONException {
        ...
        // Adds the parameters to an ArrayList as requested by the RequestManager class
