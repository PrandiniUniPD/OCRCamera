...
public class Register_VM extends ViewModel implements RegisterMethods {
    ...
    public void registerUserToForum(final Context context, final String username, final String password, final String name, final String surname) {
        ...
        //Definition of the listener triggered by checkUsername requests
        dbListeners.completeListener = new OnCompleteListener<QuerySnapshot>() {

            /**
             * Defines what to do when the checkUsername request has finished
             *
        ...
        //Definition of the listeners triggered by registerUser requests
        dbListeners.successListener = new OnSuccessListener() {

            /**
             * Defines what to do when the registerUser request is successful
             *
             * @param o The data generated by the listener, kept generic not being useful at all
             */
            @Override
        ...
        dbListeners.failureListener = new OnFailureListener() {
            ...
            /**
             * Defines what to do when the registerUser request fails
             *
             * @param e The exception about what went wrong with the request
             */
            @Override
