...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mButtonGallery = findViewById(R.id.gallery_button);
        ...
        mButtonGallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Intent gallery = new Intent(CameraActivity.this, GallerySelectionActivity.class);
                gallery.putExtra("PATH_GALLERY", bitmapManager.getPath());
