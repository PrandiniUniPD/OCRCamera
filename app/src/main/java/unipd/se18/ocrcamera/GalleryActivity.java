...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //When the activity starts the first thing that I do i check for storage permission
        //If the function returns true I'll load the home page.
    ...
    public static class MainFragment extends Fragment
    {
        ...
        public void onHiddenChanged(boolean hidden)
        {
            ...
            if(!hidden)
            {
                ...
                //Calling .getDeletedPhotoPosition() I check if the value is -1, if not I get the position of
    ...
    public static class DetailFragment extends Fragment
    {
        ...
        public boolean onOptionsItemSelected(MenuItem item)
        {
            switch (item.getItemId()) {
                ...
                //I've cliecked the bin icon. Delete the current photo and close the detailsFragment
        ...
        public void onViewCreated(View view, Bundle savedInstanceState)
        {
            //Load the PhotoStructure object of the photo that I want to load from the bundle
         ...
         * Method called from onOptionsItemSelected
         */
        ...
        /**
         * Show a simple error message when something occur during the deletion of an image
         */
        private void showDeletingErrorDialog()
        {
    ...
    private void showPermissionErrorDialog()
    {
        ...
        builder.setTitle("Permission error")
                .setMessage("You did not have authorized the app to use internal storage. The app will be closed.")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
