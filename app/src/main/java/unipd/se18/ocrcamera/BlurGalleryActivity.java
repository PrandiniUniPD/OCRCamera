...
public class BlurGalleryActivity extends AppCompatActivity {
    ...
    /**
     * ListView to show all the ingredients in a listllayout
     */
    ...
    /**
     * listllayout of elements inside PHOTOS_FOLDER
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.listllayout);
        ...
        BlurObjectAdapter adapter = new BlurObjectAdapter(this, R.layout.listllayout, arrayBlur);
