...
public class ImageProcessing {
    ...
    */
    ...
    public RotatedRect detectMinTextArea(String inFile) throws FileNotFoundException{
        ...
        Imgproc.Laplacian(img, laplacian, 3, 3, 1, 0, Core.BORDER_TRANSPARENT);
        save(laplacian, "laplacian.jpg");*/

        //Detect the edges in the image
        Mat canny = new Mat();
        Imgproc.Canny(img, canny, 50, 200, 3, false);
        ...
        Imgproc.threshold(img, imgThreshold, 0, 255, Imgproc.THRESH_OTSU | Imgproc.THRESH_BINARY);
