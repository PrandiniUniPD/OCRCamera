<?php
    /**
     * Pagina per l'inserimento delle foto
     */

    //Mostra informazioni in caso di errore
    ini_set('display_errors', 1);
    ini_set('display_startup_errors', 1);
    error_reporting(E_ALL);

    session_start();
    //Redirect dell'utente in caso non abbia fatto il login
    if (!isset( $_SESSION['user'] ) ) {
    header("location: /index.php");
    }

    //Nome della foto che vorrà salvare su file
    ...
    //Ottengo il numero di foto originali presenti sul database
    ...
    //Dato un array di nomi di tag, rirotrna un array contenente i relativi id
    ...
    //Ottieni un id valido per una nuova foto
    ...
    //Salva la foto sul databasem inserisce l'immagine e descrizione sulla cartella /foto
    function post($mysqli){
        ...
        //imposto il testo in formato JSON
        /*
        {
