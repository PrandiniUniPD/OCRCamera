    ...
    public static class RecycleCardsAdapter extends RecyclerView.Adapter<RecycleCardsAdapter.CardViewHolder> {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentManager fm = ((GalleryFragment)mainActivity).getFragmentManager();
                FragmentTransaction ft = fm.beginTransaction();
                GalleryFragment.DetailFragment detailedFragment = new GalleryFragment.DetailFragment();
        ...
        public void onBindViewHolder(final CardViewHolder holder, final int listPosition) {
            ...
            holder.txtTitle.setText("HERE ALLERGENS");
        }
