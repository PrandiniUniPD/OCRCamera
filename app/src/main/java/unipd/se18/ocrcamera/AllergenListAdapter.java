...
public class AllergenListAdapter extends ArrayAdapter<Allergen> {
    ...
    AllergenListAdapter(Context context, int resource, ArrayList<Allergen> objects) {
        //adapt the Allergens List "objects"
        super(context, resource, objects);
        mContext = context;
        //in our practical case we will be using allergen_single.xml
        mResource = resource;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        try {
            ...
            //create the Allergen in the layout
            ...
            //set ToggleButton to checked or not depending on the value of "selected"
            ...
            Log.e(TAG, "Missing Allergens' parameters");
            npe.printStackTrace();
        }
        return convertView;
    }
